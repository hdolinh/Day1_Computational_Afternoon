...
Some examples using `log()` function and `exp()` **function** in R.
...
# To what power do I have to raise e to get a power of blank?

```

### Creating squences of values
...
time_vec <- seq(from = 0, to = 30, by =1)
